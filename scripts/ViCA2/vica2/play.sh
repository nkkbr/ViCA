...
# bash scripts/myscript_20250424_final/play.sh >> scripts/myscript_20250424_final/play.log 2>&1
...
IMAGE_FOLDER="XXX"
VIDEO_FOLDER="[YOUR VIDEO_FOLDER]"
DATA_YAML="[YOUR DATA_YAML]" # e.g exp.yaml
...
PREV_STAGE_CHECKPOINT="[YOUR STAGE2 CHECKPOINT]"
