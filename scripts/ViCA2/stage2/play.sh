...
# bash scripts/myscript_20250416_stage2/play.sh >> scripts/myscript_20250416_stage2/play1.log 2>&1
...
IMAGE_FOLDER="/stage2/image_folder"
VIDEO_FOLDER="XXX"
DATA_YAML="scripts/ViCA2/stage2/exp1.yaml" # e.g exp.yaml
...
MID_RUN_NAME="vica2_stage2"
# PREV_STAGE_CHECKPOINT="lmms-lab/LLaVA-Video-7B-Qwen2"
PREV_STAGE_CHECKPOINT="work_dirs/pretrain"
